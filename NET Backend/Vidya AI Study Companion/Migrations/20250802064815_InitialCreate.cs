    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudyMaterials", x => x.ResourceId);
                    table.ForeignKey(
                        name: "FK_StudyMaterials_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NativeLanguage = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    SummaryNt = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
